...
def get_children(node, expanded):
    ...
    for move in moves:
        ...
        if (curr_y > 2 or curr_y < 0 or curr_x > 2 or curr_x < 0):
...
"""
  Checks that input list is the correct length (9) and 
...
"""
  ...
  Returns:
    3 by 3 matrix (list of 3 lists with length 3)
"""
